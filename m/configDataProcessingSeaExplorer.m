...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  processing_options.oxygen_sat_list(1).oxygen_sat     = 'oxygen_sat';
  ...
  processing_options.abs_salinity_list(1).abs_salinity     = 'absolute_salinity';
  ...
  processing_options.sigmat_list(1).abs_salinity    = 'absolute_salinity';
