...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  var_attr_list.AROD_FT_DO = {
    ...
    'standard_name' 'Oxygen concentration'
    'units'         'umol L-1'
    'comment'       'Rinko FT sensor'
    '_FillValue'    default_fill_value };

  var_attr_list.AROD_FT_TEMP = {
    'long_name'     'Temperature associated with Oxygen concentration'
    'standard_name' 'Temperature associated with Oxygen concentration'
    'units'         'Celsius'
    'comment'       'Rinko FT sensor'
    '_FillValue'    default_fill_value };
  ...
  global_atts = ...
  {
    ...
    'institution'                  'BIO' % institution_name
