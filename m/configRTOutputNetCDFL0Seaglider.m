function ncl0_info = configRTOutputNetCDFL0Seaglider()
%CONFIGRTOUTPUTNETCDFL0SEAGLIDER  Configure NetCDF output for raw Seaglider glider deployment data in real time.
%
%  Syntax:
