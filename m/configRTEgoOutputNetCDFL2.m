function ncl2_info = configRTOutputNetCDFL2()
...
%  error(nargchk(0, 0, nargin, 'struct'));
  ...
  var_attr_list.time = {
    ...
    'standard_name' 'TIME'
    'units'         'seconds since 1970-01-01T00:00:00 +00:00Z'
    'axis'          'T'
    'valid_min'     0.
    'valid_max'     9000.
    'QC_procedures' 'EGO QC not applied yet'
  ...
  global_atts = ...
  {
    ...
    'institution'                  'DFO' % institution_name
    'institution_references'       '' % institution_references
    'data_assembly_center'         'MEDS'
    ...
    'title'                        'Glider deployment real time gridded data'
  ...
  dims = [(struct('name', {'time'}, 'length', {0})),...
           (struct('name', {'depth'}, 'length', {[]}))...           
           ];
