...
var_attr_list.absolute_salinity = {
  ...
  global_atts = ...
  {
    'abstract'                     'AZMP Halifax line' % deployment_description
    'acknowledgement'              '' % deployment_acknowledgement
    'author'                       'Melany Belzile' % deployment_author
    'author_email'                 'melany.belzile@dfo-mpo.gc.ca' % deployment_author_email
...
%     'geospatial_lon_units'         'undefined'
    ...
    'institution'                  'Fisheries and Oceans Canada, Bedford Institute of Oceanography' % institution_name
    'institution_references'       'www.bio-iob.gc.ca' % institution_references
    'instrument'                   'Glider' % instrument_name
    'instrument_manufacturer'      'Alseamar' % instrument_manufacturer
    'instrument_model'             'SeaExplorer' % instrument_model
    ...
    'principal_investigator'       'David Hebert' % deployment_principal_investigator
    'principal_investigator_email' 'David.Hebert@dfo-mpo.gc.ca' % deployment_principal_investigator_email
...
%     'summary'                      '' % deployment_description
    ...
    'country code'                 '1810'
    'deployment platform'          'CCGS Sigma-t'
    'cruise number'                ''
   
%    %SEA019
%     'wmo_platform_code'            '4800925'
%     'wmo_inst_type'                '830'
%     'GPCTD s/n'                    '0186'
%     'GPCTD cal date'               'May 2016'
%     'Oxygen sensor s/n'            '43-3338'
%     'Oxygen sensor cal date'       'April 2016'
%     'CTD pump s/n'                 '05-8709'
%     'Ecopuck sensor s/n'           '4551'
%     'Ecopuck sensor cal date'      'November 2016' 
%         %2016- Oct 2018
%     'oxygen calibration coef'      'Soc = 3.2305e-4; Foffset = -830.74; A = -3.4562e-3; B = 1.1709e-4;C = -1.7302e-6; Enom = 0.036;'
%         %Dec 2018-...
% %     'oxygen calibration coef'      ''
%    %SEA021
%     'wmo_platform_code'            '4800926'
%     'wmo_inst_type'                '830'
%     'GPCTD s/n'                    '0184'
%     'CTD pump s/n'                 '05-8698'
%     'Ecopuck sensor s/n'           '4548'
%     'Ecopuck sensor cal date'      'December 2016' 
%         %2016-July 2018
%     'GPCTD cal date'               'May 2016'
%     'Oxygen sensor s/n'            '43-3336'
%     'Oxygen sensor cal date'       'April 2018'
%     'oxygen calibration coef'      'Soc = 2.7945e-4; Foffset = -794.20; A = -3.4437e-3; B = 1.5480e-4;C = -2.3721e-6; Enom = 0.036;'
% %         %Aug 2018-...
% %     'GPCTD cal date'               'July 2016'
% %     'Oxygen sensor s/n'            '43-3336'
% %     'Oxygen sensor cal date'       'August 2018'        
% %     'oxygen calibration coef'      'Soc = 2.8722e-4; Foffset = -777.23; A = -4.4454e-3; B = 1.8630e-4;C = -2.8650e-6; Enom = 0.036;'
%    %SEA022
%     'wmo_platform_code'            '4800993'
%     'wmo_inst_type'                '830'
%     'Ecopuck sensor s/n'           '4546'
%     'Ecopuck sensor cal date'      'December 2016' 
%     'GPCTD s/n'                    '0175'
%     'CTD pump s/n'                 '05-8272'
%         %2016- Dec 2018... 
%     'GPCTD cal date'               'March 2016'
%     'Oxygen sensor s/n'            '43-3276'
%     'Oxygen sensor cal date'       'January 2016'    
%     'oxygen calibration coef'      'Soc = 3.1884e-4; Foffset = -807.15; A = -4.2074e-3; B = 2.2413e-4;C = -3.4516e-6; Enom = 0.036;'
% %         %2019-...
% %     'GPCTD cal date'               ''
% %     'Oxygen sensor s/n'            '43-3276'
% %     'Oxygen sensor cal date'       ''    
% %     'oxygen calibration coef'      ''
%    %SEA024
%     'wmo_platform_code'            '4800994'
%     'wmo_inst_type'                '830'
%     'Ecopuck sensor s/n'           '4550'
%     'Ecopuck sensor cal date'      'December 2016' 
%     'CTD pump s/n'                 '05-8711'
%     'GPCTD s/n'                    '0188'
%         %2016-July 2018 
%     'GPCTD cal date'               'May 2016'
%     'Oxygen sensor s/n'            '43-3365'
%     'Oxygen sensor cal date'       'April 2016'
%     'oxygen calibration coef'      'Soc = 2.8277e-4; Foffset = -847.84; A = -2.8377e-3; B = 1.2076e-4;C = -2.0639e-6; Enom = 0.036;'  
% %         %Aug 2018-...
% %     'GPCTD cal date'               'July 2018'
% %     'Oxygen sensor s/n'            '43-3365'
% %     'Oxygen sensor cal date'       'August 2018'    
...
%     'wmo_inst_type'                '830'
%     'GPCTD s/n'                    '0241'
%     'GPCTD cal date'               'November 2017'
%     'CTD pump s/n'                 '05-9310'
%     'Oxygen sensor s/n'            '0020'
%     'Oxygen sensor cal date'       'November 2017'
%     'Ecopuck sensor s/n'           '4739'
%     'Ecopuck sensor cal date'      'May 2017' 
%         %2016-...
%     'oxygen calibration coef'      'd0 = -3.632811e-4; d1 = -1.540711e-1; d2 = 1.869242e-1; d3 = 0; d4 = 0; c0 = 3.163416e-3; c1 = 1.330233e-4; c2= 2.762195e-6; e0 = 1; Cp = 4.4e-3;'
%         %
%     %'oxygen calibration coef'      ''
     };
