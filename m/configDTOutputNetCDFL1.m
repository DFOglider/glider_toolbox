...
%     'Ecopuck_sensor_sn'           '4551'
%     'Ecopuck_sensor_cal_date'      'November 2016' 
%         %2016- Oct 2018
%     'GPCTD_cal_date'               'May 2016'
%     'oxygen_sensor_manufacturer'   'Sea-Bird Electronics'
%     'oxygen_sensor_sn'            '43-3338'
%     'oxygen_sensor_cal_date'       'April 2016'
%     'oxygen_cal_coef'              'Soc = 3.2305e-4; Foffset = -830.74; A = -3.4562e-3; B = 1.1709e-4;C = -1.7302e-6; Enom = 0.036;'
%         %Dec 2018-...
% %     'GPCTD_cal_date'               'December 2018'
% %     'oxygen_sensor_manufacturer'   'Sea-Bird Electronics'
% %     'oxygen_sensor_sn'            '43-3338'
% %     'oxygen_sensor_cal_date'       'December 2018'
% %     'oxygen_cal_coef'             'Soc = 2.8304e-4; Foffset = -835.35; A = -3.7649e-3; B = 1.1716e-4;C = -1.3298e-6; Enom = 0.036;'
%    %SEA021
%     'glider_sn'                   'SEA021'
...
%     'Ecopuck_sensor_manufacturer'  'WetLab'
%     'Ecopuck_sensor_model'         'FLBBCD - EXP'
%     'Ecopuck_sensor_sn'           '4548'
%     'Ecopuck_sensor_cal_date'      'December 2016' 
%         %2016-July 2018
%     'GPCTD_cal_date'               'May 2016'
%     'oxygen_sensor_manufacturer'   'Sea-Bird Electronics'
%     'oxygen_sensor_sn'            '43-3336'
%     'oxygen_sensor_cal_date'       'April 2018'
%     'oxygen_cal_coef'              'Soc = 2.7945e-4; Foffset = -794.20; A = -3.4437e-3; B = 1.5480e-4;C = -2.3721e-6; Enom = 0.036;'
% %         %Aug 2018-...
% %     'GPCTD_cal_date'               'July 2016'
% %     'oxygen_sensor_manufacturer'   'Sea-Bird Electronics'
% %     'oxygen_sensor_sn'            '43-3336'
% %     'oxygen_sensor_cal_date'       'August 2018'        
% %     'oxygen_cal_coef'              'Soc = 2.8722e-4; Foffset = -777.23; A = -4.4454e-3; B = 1.8630e-4;C = -2.8650e-6; Enom = 0.036;'
%    %SEA022
%     'glider_sn'                   'SEA022'
...
%     'Ecopuck_sensor_manufacturer'  'WetLab'
%     'Ecopuck_sensor_model'         'FLBBCD - EXP'
%     'Ecopuck_sensor_sn'           '4546'
%     'Ecopuck_sensor_cal_date'      'December 2016' 
%     'GPCTD_manufacturer'           'Sea-Bird Electronics'
%     'GPCTD_sn'                    '0175'
%     'CTD_pump_sn'                 '05-8272'
%         %2016- Dec 2018... 
%     'GPCTD_cal_date'               'March 2016'
%     'oxygen_sensor_manufacturer'   'Sea-Bird Electronics'
%     'oxygen_sensor_sn'            '43-3276'
%     'oxygen_sensor_cal_date'       'January 2016'    
%     'oxygen_cal_coef'             'Soc = 3.1884e-4; Foffset = -807.15; A = -4.2074e-3; B = 2.2413e-4;C = -3.4516e-6; Enom = 0.036;'
% %         %2019-...
% %     'GPCTD_cal_date'               ''
% %     'oxygen_sensor_manufacturer'   'Sea-Bird Electronics'
% %     'oxygen_sensor_sn'            '43-3276'
...
%     'oxygen_cal_coef'              'Soc = 3.1993e-4; Foffset = -834.99; A = -3.6818e-3; B = 1.4127e-4;C = -2.2880e-6; Enom = 0.036;'
   %SEA032
    ...
    'Ecopuck_sensor_manufacturer'  'WetLab'
    'Ecopuck_sensor_model'         'FLBBCD - EXP'
    'Ecopuck_sensor_sn'           '4739'
    'Ecopuck_sensor_cal_date'      'May 2017' 
        %2016-...
    'oxygen_sensor_manufacturer'  'JFE Advantech Co'
    'oxygen_sensor_model'         'Rinko AROD-FT'
    'oxygen_sensor_sn'            '0020'
    'oxygen_sensor_cal_date'       'November 2017'
    'oxygen_cal_coef'             'd0 = -3.632811e-4; d1 = -1.540711e-1; d2 = 1.869242e-1; d3 = 0; d4 = 0; c0 = 3.163416e-3; c1 = 1.330233e-4; c2= 2.762195e-6; e0 = 1; Cp = 4.4e-3;'
        %
%     'oxygen_sensor_sn'            '0020'
%     'oxygen_sensor_cal_date'       ''
%     %'oxygen_cal_coef'      ''
