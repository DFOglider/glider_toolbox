...
basic_qc_configuration.preprocessing.summaryFileName = 'c:\users\trana\matlab\glider_Project\qc_preprocessing.log';

basic_qc_configuration.processing.performQC = true;
basic_qc_configuration.processing.summaryFileName = 'c:\users\trana\matlab\glider_Project\qc_processing.log';

basic_qc_configuration.gridding.performQC = false;

% Experimental use only.
basic_qc_configuration.processing.plotSuspiciousProfiles = true;
