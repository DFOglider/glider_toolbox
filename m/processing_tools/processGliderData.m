...
%         end
  ...
  for oxygen_saturation_option_idx = 1:numel(options.oxygen_saturation_list)
    ...
    if all(isfield(data_proc, {oxygen_saturation_oxc oxygen_saturation_salt oxygen_saturation_temp}))
      ...
      meta_proc.(oxygen_saturation_oxs).sources = ...
        {oxygen_saturation_oxc oxygen_saturation_salt oxygen_saturation_temp}';
      meta_proc.(oxygen_saturation_oxs).method = 'sw_satO2';
    end
  end
  %% Rinko corrected oxygen concentration from oxygen concen at S=0 in umol, CTD salinity, CTD temp, Oxygen sensor Temp

  for oxygen_conc_rinko_option_idx = 1:numel(options.oxygen_conc_rinko_list)
    oxygen_conc_rinko_option = options.oxygen_conc_rinko_list(oxygen_conc_rinko_option_idx);
    oxygen_conc_rinko_oxc = oxygen_conc_rinko_option.oxygen_conc_rinko;
    oxygen_conc_rinko_oxumol = oxygen_conc_rinko_option.oxygen_concentration;
    oxygen_conc_rinko_ctdtemp = oxygen_conc_rinko_option.temperature;
    oxygen_conc_rinko_ctdsalt = oxygen_conc_rinko_option.salinity;
    oxygen_conc_rinko_temp = oxygen_conc_rinko_option.temperature_oxygen;
    if all(isfield(data_proc, {oxygen_conc_rinko_oxumol oxygen_conc_rinko_ctdtemp oxygen_conc_rinko_temp oxygen_conc_rinko_ctdsalt}))
   
  fprintf('Deriving oxygen_conc %d with settings:\n', oxygen_conc_rinko_option_idx);
      fprintf('  output oxygen_conc sequence   : %s\n', oxygen_conc_rinko_oxc);
      fprintf('  input oxygen_umol sequence: %s\n', oxygen_conc_rinko_oxumol);
      fprintf('  input salinity sequence: %s\n', oxygen_conc_rinko_ctdtemp);
      fprintf('  input ctdsalinity sequence: %s\n', oxygen_conc_rinko_ctdsalt);
      ...
      meta_proc.(oxygen_conc_rinko_oxc).sources = ...
        {oxygen_conc_rinko_oxumol oxygen_conc_rinko_ctdtemp oxygen_conc_rinko_ctdsalt oxygen_conc_rinko_temp}';
      meta_proc.(oxygen_conc_rinko_oxc).method = 'Saturation calculated with S=0 feed on Oxygen saturation formula with S from and T from CTD';
    end
  end  
 
  %% Rinko Oxygen saturation
 for oxygen_saturation_rinko_option_idx = 1:numel(options.oxygen_saturation_rinko_list)
    oxygen_saturation_rinko_option = options.oxygen_saturation_rinko_list(oxygen_saturation_rinko_option_idx);
    oxygen_saturation_rinko_oxs = oxygen_saturation_rinko_option.oxygen_saturation_rinko;
    oxygen_saturation_rinko_oxc = oxygen_saturation_rinko_option.oxygen_conc_rinko;
    oxygen_saturation_rinko_salt = oxygen_saturation_rinko_option.salinity;
    oxygen_saturation_rinko_temp = oxygen_saturation_rinko_option.temperature;
    if all(isfield(data_proc, {oxygen_saturation_rinko_oxc oxygen_saturation_rinko_salt oxygen_saturation_rinko_temp}))
 
      fprintf('Deriving oxygen_saturation %d with settings:\n', oxygen_saturation_rinko_option_idx);
      fprintf('  output oxygen_saturation sequence   : %s\n', oxygen_saturation_rinko_oxs);
      fprintf('  input oxygen_conc sequence: %s\n', oxygen_saturation_rinko_oxc);
      fprintf('  input salinity sequence: %s\n', oxygen_saturation_rinko_salt);
      fprintf('  input temperature sequence : %s\n', oxygen_saturation_rinko_temp);
  
      data_proc.(oxygen_saturation_rinko_oxs) = ...
        (data_proc.(oxygen_saturation_rinko_oxc)./sw_satO2(data_proc.(oxygen_saturation_rinko_salt),data_proc.(oxygen_saturation_rinko_temp)))*100;

      meta_proc.(oxygen_saturation_rinko_oxs).sources = ...
        {oxygen_saturation_rinko_oxc oxygen_saturation_rinko_salt oxygen_saturation_rinko_temp}';
      meta_proc.(oxygen_saturation_rinko_oxs).method = 'sw_satO2';
    end
  end
end
